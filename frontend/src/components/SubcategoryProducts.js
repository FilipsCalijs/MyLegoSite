...
const SubcategoryProducts = () => {
  ...
  return (
    <div className="container mt-4">
          ...
          <tbody>
            {paginatedProducts.map((p) => (
              <tr key={p.id}>
                ...
                <td>{p.name.length > 100 ? p.name.slice(0, 10) + '...' : p.name}</td>
      ...
      <div className="d-flex justify-content-between align-items-center mt-3 pagination-mobile">
        <button
